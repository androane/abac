# -*- coding: utf-8 -*-
# Generated by Django 5.0.1 on 2024-03-07 08:13
...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.AddField(
            ...
            name="client",
            field=models.ForeignKey(
                on_delete=django.db.models.deletion.CASCADE, to="organization.client"
            ),
        ),
        migrations.AddField(
        ...
        migrations.AddConstraint(
            ...
            constraint=models.UniqueConstraint(
                condition=models.Q(
                    ("deleted__isnull", True), ("client__isnull", False)
                ),
                fields=("name", "client"),
                name="organization_activity_name_client_unique",
            ),
        ),
        migrations.AddConstraint(
            model_name="activity",
            constraint=models.UniqueConstraint(
                ...
                name="organization_activity_name_organization_unique",
            ),
        ),
        migrations.AddConstraint(
            model_name="clientactivity",
